...
CREATE TABLE `cliente` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8852 DEFAULT CHARSET=latin1 COMMENT='Contenedor de clientes';
...
('action_orden_crearOrden',0,'',NULL,'N;'),
('action_orden_create',0,'',NULL,'N;'),
('action_orden_index',0,'',NULL,'N;'),
('action_repuesto_admin',0,'',NULL,'N;'),
('action_repuesto_create',0,'',NULL,'N;'),
('action_repuesto_index',0,'',NULL,'N;'),
...
(1,'default',NULL,800,10,1,-1,-1,0,0,0,0,'',0,'RolNormal','',1);
...
(1,NULL,NULL,1376047573,'admin','admin@tucorreo.com','admin',NULL,1,0,0),
...
CREATE TABLE `estado` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Contenedor de estados';
...
CREATE TABLE `historial` (
  ...
  CONSTRAINT `fk_historial_orden1` FOREIGN KEY (`orden_id`) REFERENCES `orden` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `marca` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=latin1 COMMENT='Contenedor de Marcas de equipos';
...
CREATE TABLE `orden` (
  ...
  KEY `fk_orden_cruge_user1_idx` (`usr_id`),
  KEY `fk_orden_marca1_idx` (`mar_id`),
  CONSTRAINT `fk_orden_sucursal1` FOREIGN KEY (`suc_id`) REFERENCES `sucursal` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_orden_cliente1` FOREIGN KEY (`cli_id`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_orden_cruge_user1` FOREIGN KEY (`usr_id`) REFERENCES `cruge_user` (`iduser`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_orden_marca1` FOREIGN KEY (`mar_id`) REFERENCES `marca` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_orden_aparato1` FOREIGN KEY (`apa_id`) REFERENCES `aparato` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Contenedor de ordenes de trabajo';
...
CREATE TABLE `repuesto` (
  ...
  CONSTRAINT `fk_repuestos_tipo_repuesto1` FOREIGN KEY (`tip_id`) REFERENCES `tipo_repuesto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `repuesto_orden` (
  ...
  CONSTRAINT `fk_repuestos_orden_repuestos1` FOREIGN KEY (`rep_id`) REFERENCES `repuesto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_repuestos_orden_orden1` FOREIGN KEY (`ord_id`) REFERENCES `orden` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `sucursal` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='contenedor de sucursales';
