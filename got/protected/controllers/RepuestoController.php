  ...
  private function registerAssets(){
	...
	protected function performAjaxValidation($model)
	{
        ...
        public function actionAjax(){
	     $this->layout='//layouts/ajax_view'; 
	     $model=new Repuesto('search');
	     $model->unsetAttributes();  // clear any default values
	     if(isset($_GET['Repuesto']))
			  $model->attributes=$_GET['Repuesto'];
	
	     $this->render('ajax',array('model'=>$model,'oid'=>$_GET["oid"]));	
	}
	...
	public function actionAjax_Usar(){
		if(isset($_POST['update_id'])){
			$RO = new RepuestoOrden();
			$RO->rep_id = $_POST['update_id'];
			$RO->ord_id = $_POST['oid'];
			$RO->save(false);
			$model=$this->loadModel($_POST['update_id']);
