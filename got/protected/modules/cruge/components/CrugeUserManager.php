...
class CrugeUserManager
{
    ...
    */
    ...
    public function MygetInputField($model, ICrugeField $field)
    {
        ...
        switch ($field->fieldtype) {
            ...
            case CRUGEFIELDTYPE_LISTBOX:
                ...
                //return CHtml::dropDownList($name,CHtml::listData(Sucursal::model()->findAll(), 'id'),CHtml::listData(Sucursal::model()->findAll(), 'sucursal'), 'sucursal');
                return CHtml::dropDownList(
                    $name,
                    $field->getFieldValue(),
                    $arOpt,
